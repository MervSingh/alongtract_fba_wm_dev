...
write_csv(
  model_summaries_df,
  "./Lin_Quad_Reduced/AssocProj_ModelSummaries_LinRed_QuadRed_fd.csv"
)
...
# =========================================================
write_csv(delta_df,
          "./Lin_Quad_Reduced/LinQuad_DeltaAIC_AssocProj_fd.csv")
...
# =========================================================
ggsave(
  "./Lin_Quad_Reduced/LinQuad_DeltaAIC_Heatmap_AssocProj_fd.pdf",
  p_heat,
  width = 14,
  height = 6,
  device = cairo_pdf
...
pdf(
  "./Lin_Quad_Reduced/AgeAtScan_ForestPlots_LinRed_QuadRed_AssocProj_fd_.pdf",
  width = 18,
  height = 6,
  useDingbats = FALSE
)
...
# FUNCTION
# =========================================================
plot_lme_marginal_linquad_reduced_fd <- function(
    df,
    tract,
    hemi,
    seg,
...
for (tract in selected_tracts) {
  ...
  for (hemi in c("left", "right")) {
    ...
    for (seg in tract_segments) {
      ...
      p <- plot_lme_marginal_linquad_reduced_fd(
        df = df,
        tract = tract,
        hemi = hemi,
        seg = seg,
...
pdf(
  "./Lin_Quad_Reduced/MarginalPlots_LinQuad_ReducedModel_AssocProj_fd_v2.pdf",
  width = 11,
  height = 8.5,
  useDingbats = FALSE
)
...
pdf(
  "./Lin_Quad_Reduced/MarginalPlots_LinQuad_ReducedModel_AssocProj_FD_4x2.pdf",
  width = 12,
  height = 20,
  useDingbats = FALSE
)
