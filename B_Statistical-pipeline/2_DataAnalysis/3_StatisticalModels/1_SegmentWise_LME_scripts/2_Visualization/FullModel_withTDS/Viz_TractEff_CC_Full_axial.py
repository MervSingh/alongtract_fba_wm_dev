...
# -*- coding: utf-8 -*-
"""
Corpus Callosum FD/FC effect size overlays (AXIAL view, NO HEMISPHERE)
----------------------------------------------------------------------
- Uses CSV estimates (CC1–CC7)
- Maps to mask filenames (CC_1–CC_7)
- No hemisphere splitting
- Axial projection (true axial MIP)
...
output_dir = "/PATH/TO/OUTPUT/CC_tracts_full"
...
for tract in cc_tracts:
    ...
    for metric in metrics:
        ...
        outpath = os.path.join(
            output_dir,
            f"{tract}_{metric}_axial_v2_full.png"
        )
...
print("\n✅ CC AXIAL NO-HEMISPHERE pipeline complete.")