...
# Load data
# ===============================
df = pd.read_csv('/PATH/TO/INPUT/merged_output.csv')
...
# Output directory
# ===============================
output_dir = '/PATH/TO/OUTPUT/boxplots_thresholdedFD_before_cleaning'
...
def plot_category(category_name, tract_list, show_legend=True):
    ...
    plt.suptitle(f'{category_name} Tracts: FD Retained % per Segment (before cleaning)',
    ...
    output_path = os.path.join(output_dir, f'{category_name}_FD_Retained_ThresholdedFD_Before_Cleaning.png')
    fig.set_dpi(600)
