...
excel_path <- "~/PATH/TO/INPUT/HeatMap_Plot_full.xlsx"

out_dir <- "~/PATH/TO/OUTPUT/Heatmaps_Full"
...
ggsave(
  file.path(out_dir,
            "Association_Heatmap_AP_DS_Full.png"),
  plot_assoc_combined,
  width = 20,
  height = 10,
  dpi = 300
...
ggsave(
  file.path(out_dir,
            "Association_Heatmap_SA_Full.png"),
  plot_assoc_SA,
  width = 8,
  height = 6,
  dpi = 300
...
ggsave(
  file.path(out_dir,
            "Association_Heatmap_SA_DS_Full.png"),
