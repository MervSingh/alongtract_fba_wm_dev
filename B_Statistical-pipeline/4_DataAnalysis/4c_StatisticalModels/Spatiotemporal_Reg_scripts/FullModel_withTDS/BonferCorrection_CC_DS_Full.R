...
fd_input <- file.path(
  base_dir,
  "CC_GradModels_Results_FD_Full.csv"
)

fc_input <- file.path(
  base_dir,
  "CC_GradModels_Results_FC_Full.csv"
)
...
write_csv(
  ...
  file.path(
    output_dir,
    "Bonferroni_By_TractGroup_CC_DS_FD_Full.csv"
  )
)
...
write_csv(
  ...
  file.path(
    output_dir,
    "Bonferroni_By_TractGroup_CC_DS_FC_Full.csv"
  )
)
