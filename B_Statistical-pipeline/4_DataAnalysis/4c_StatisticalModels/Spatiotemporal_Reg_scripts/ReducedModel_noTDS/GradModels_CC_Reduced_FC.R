...
# Read and preprocess
# -----------------------------
df <- read_csv("/PATH/TO/INPUT/CC_ModelSummaries_Reduced_Full_TDS_FC.csv",
               col_types = cols(
                 .default = col_guess(),
...
write_csv(
  ...
  "/PATH/TO/OUTPUT/CC_Relabeled_Results_FC.csv"
)
...
write_csv(
  combined_CC,
  "/PATH/TO/OUTPUT/CC_GradModels_Results_FC.csv"
)
