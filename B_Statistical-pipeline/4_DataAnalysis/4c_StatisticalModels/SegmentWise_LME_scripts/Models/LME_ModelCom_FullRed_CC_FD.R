...
write_csv(
  model_summaries_df,
  "./LME/output/CC_ModelSummaries_Reduced_Full_TDS_FD.csv"
)

write_csv(
  delta_df,
  "./LME/output/CC_DeltaAIC_TDS_FD.csv"
)
...
# =========================================================
ggsave(
  "./LME_Plots/CC_DeltaAIC_TDS_Heatmap_CC_FD.pdf",
  p_heat,
  width = 12,
  height = 5,
  device = cairo_pdf
...
pdf(
  "./LME_Plots/AgeAtScan_ForestPlots_Reduced_vs_Full_CC_FD_TDS.pdf",
  width = 12,
  height = 5,
  useDingbats = FALSE
)
...
plot_lme_marginal_cc_fd <- function(df,
                                    tract,
                                    seg,
                                    show_spaghetti = TRUE) {
...
pdf(
  "./LME_Plots/MarginalPlots_ReducedModel_CC_FD_v2.pdf",
  width = 11,
  height = 8.5,
  useDingbats = FALSE
)
...
cat("DONE: CC marginal reduced-model FD plots saved.\n")