...
# Load summary files
df_fd = pd.read_csv('/PATH/TO/INPUT/summary_fd_values.csv')
df_fc = pd.read_csv('/PATH/TO/INPUT/summary_fc_values.csv')
df_demo = pd.read_csv('/PATH/TO/INPUT/demographics.csv')  # Demographics file
...
# Save to CSV
df_merged.to_csv('/PATH/TO/OUTPUT/merged_output.csv', index=False)
