...
write_csv(
  model_summaries_df,
  "./Lin_Quad_Reduced/CC_ModelSummaries_LinRed_QuadRed_FC.csv"
)

write_csv(
  delta_df,
  "./Lin_Quad_Reduced/LinQuad_DeltaAIC_CC_FC.csv"
)
...
# =========================================================
ggsave(
  "./Lin_Quad_Reduced/LinQuad_DeltaAIC_Heatmap_CC_FC.pdf",
  p_heat,
  width = 12,
  height = 5,
  device = cairo_pdf
...
pdf(
  "./Lin_Quad_Reduced/AgeAtScan_ForestPlots_LinRed_vs_QuadRed_CC_FC_TDS.pdf",
  width = 12,
  height = 5,
  useDingbats = FALSE
)
...
pdf(
  "./Lin_Quad_Reduced/MarginalPlots_LinQuad_ReducedModel_CC_FC_v2.pdf",
  width = 11,
  height = 8.5,
  useDingbats = FALSE
)
...
pdf(
  "./Lin_Quad_Reduced/MarginalPlots_LinQuad_ReducedModel_CC_FC_4x2.pdf",
  width = 12,
  height = 20,
  useDingbats = FALSE
)
